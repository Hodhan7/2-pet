...
# Cleanup note (2025-10-23)
Some development/debug/test files were removed from the project root and backed up to:

`docs/removed_files_backup_20251023_192835`

See `docs/REMOVED_FILES.md` for the full list and backup location.
